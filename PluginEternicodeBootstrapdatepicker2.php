...
class PluginEternicodeBootstrapdatepicker2{
  public static function widget_include(){
    ...
    $element[] = wfDocument::createHtmlElement('script', null, array('src' => '/plugin/eternicode/bootstrapdatepicker2/PluginEternicodeBootstrapdatepicker2.js', 'type' => 'text/javascript'));
